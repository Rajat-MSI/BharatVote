<%-- 
    Document   : result_panel
    Created on : 28-Nov-2023, 12:41:35 pm
    Author     : rajat
--%>
...
List<ElectionProcess> electionProcessList = electionProcessManagement.getAllElectionProcessList(electionID);
        ...
        <div class="container-fluid pt-3 pb-4">
            ...
            <div class="container bg-white border rounded shadow-sm p-3 mt-5 pt-4">
                ...
                <div class="container mt-1">
                    <div class="h5 text-center"><%=electionID%> - Election Result</div>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 text-center">
                            <div class="container-fluid p-3 border rounded mt-3" style="height:700px; overflow: scroll;">
                            <%
                            for(int i=0;i<electionProcessList.size();i++)
                            {
                                ElectionProcess electionProcess = electionProcessList.get(i);
                                Party party = partyManagement.getPartyDetails(electionProcess.getPartyID());
                                ElectionProcessDAO electionProcessDAO = new ElectionProcessDAO();
                            %>
                            <h3><%=party.getPartyName()%> (<%=party.getPartyAbbreviation()%>)</h3>
                            <h3><%=electionProcessDAO.getElectionProcessCount(electionID,electionProcess.getPartyID())%></h3>
                            <%
                            }
                            %>
                            </div>
