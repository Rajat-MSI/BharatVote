<%-- 
    Document   : index
    Created on : 31-Aug-2023, 12:54:24 pm
    Author     : rajat
--%>
...
<html>
    <head>
        <title>Bharat vote - Voter login</title>
    ...
    <body>
        <div class="container-fluid p-5 bg-white">
            ...
            <div class="text-center h5 pt-3">Administration Login</div>
        </div>
                        ...
                        <div class="p-2 shadow-sm p-3 mb-5 bg-white rounded">
                            <form action="" method="post">
                                <div class="form-group m-3">
                                    ...
                                    <input type="text" placeholder="Enter your Administrative ID" class="form-control shadow-none" maxlength="8" name="admin_id" value="ADM1000" required/>
                                </div>
                                <div class="form-group m-3">
                                    <label>Password</label>
                                    <input type="password" placeholder="Enter your Password" class="form-control shadow-none" maxlength="30" name="admin_password" value="rj honey" required/>
                                </div>
                                <div class="form-group m-3">
                                ...
                                <div class="text-center m-3">
                                    <a href="register_admin.jsp" class="text-black text-decoration-none">Register Administrator</a>
                                </div>
                            </form>
                        </div>
                    </div>
...
<%
    if(request.getMethod().equalsIgnoreCase("POST"))
    {
        ...
        if(adminManagement.adminAuthentication(adminID,adminPassword) == 1)
        {
            session.setAttribute("admin_id",adminID);
            response.sendRedirect("admin_dashboard.jsp?admin="+ adminID);
        }
        else
        {
        %>
