<%-- 
    Document   : result_management
    Created on : 28-Nov-2023, 11:51:27 am
    Author     : rajat
--%>
        ...
        <div class="container-fluid pt-3 pb-4">
            ...
            <div class="container bg-white border rounded shadow-sm p-3 mt-5 pt-4">
                ...
                <div class="container mt-1">
                    <div class="h5 text-center">Result Management</div>
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="container-fluid p-3 border rounded mt-3" style="height:700px; overflow: scroll;">
                                ...
                                %>
                                <form action="result_panel.jsp?election_id=<%=election.getElectionID()%>" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <button class="btn btn-type2 btn-block" style="border:0px;" type="submit">
                                                <div class="text-hover display_gradient div_block2 m-3 p-3 border rounded shadow-sm">
                                                    ...
                                                    <table class="table table-borderless">
                                                        ...
                                                        <tr>
                                                            <td colspan="2">Click here to view result</td>
                                                        </tr>
                                                    </table>
                                                </div>
                                            </button>
